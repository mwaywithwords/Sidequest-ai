...
const INSPIRATION: Partial<Record<ObjectKey, InspirationContext>> = {
  ...
  sneaker: inspired(
    ...
    "Sneakers are used for walking and come in pairs, which supports steps and grouping.",
  ),
  book: inspired(
    "pages and chapters",
  ...
  cup: inspired(
    ...
    "A cup is used for drinking and pouring, so servings can inspire maths without inventing capacity.",
  ),
  backpack: inspired(
    "carrying items and school supplies",
    "A backpack is used to carry items, so groups of supplies can inspire maths.",
  ),
  spoon: inspired(
    "servings and portions",
    "A spoon is used for servings and portions.",
  ),
  "cereal box": inspired(
    "food portions and servings",
    "A cereal box is used for food portions without inventing this box's weight.",
  ),
};
